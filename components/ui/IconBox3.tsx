...
export default function IconBox3({
  icon: Icon,
  size = { sm: 30, md: 38, lg: 45, xl: 50 },
  className = "",
  iconClassName = "",
  ...
  return (
    <>
      ...
      <div className={`${className} block sm:hidden`}>
        <Icon
          size={sizes.sm}
          className={`p-1.5 ${backgroundColor} ${iconColor} rounded-full ${iconClassName}`}
        />
      </div>
      ...
      <div className={`${className} hidden sm:block md:hidden`}>
        <Icon
          size={sizes.md}
          className={`p-1.5 ${backgroundColor} ${iconColor} rounded-xl ${iconClassName}`}
        />
      </div>
      ...
      <div className={`${className} hidden md:block lg:hidden`}>
        <Icon
          size={sizes.lg}
          className={`p-2 ${backgroundColor} ${iconColor} rounded-xl ${iconClassName}`}
        />
      </div>
      ...
      <div className={`${className} hidden lg:block`}>
        <Icon
          size={sizes.xl}
          className={`p-2.5 ${backgroundColor} ${iconColor} rounded-xl ${iconClassName}`}
        />
      </div>
    </>
  );
